...
export async function chatInput({ interaction }: ChatInputCommandContext) {
    ...
    const embed = new EmbedBuilder() // New embed for Orbituary Contested Zone
        .setColor('#701515') // Should we have different colors for each contested zone?
        .setTitle('Welcome to Orbituary!')
        .setDescription(`Hello <@${user.id}>, here is the latest information for Orbituary and where to find the Comp boards inside of Orbituary Contested Zone.`)
        .addFields(
            {
        ...
        .setImage('https://i.postimg.cc/brhKyvWs/contested-zones-maps-orbituary-ruin-station-checkmate-v0-sb4oko35mbde1.webp')
        .setFooter({text: "Orbituary Contested Zone - Map and Information"})
