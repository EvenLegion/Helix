...
//#region src/app/commands/faq/pyam-sec-key-card.ts
const command = {
	name: "redkey",
...
async function chatInput({ interaction }) {
	...
	const embed = new EmbedBuilder().setColor("#701515").setTitle("PYAM-Security KeyCard Information").setDescription(`Hello <@${user.id}>, here is the latest information for obtaining the PYAM-Security KeyCard and how to get it.`).addFields({
		...
		inline: false
	}).setImage("https://i.postimg.cc/LXRkjLT5/image-2025-06-17-000254349.png").setFooter({ text: "PYAM-Security KeyCard - Map and Information" });
	await interaction.reply({ embeds: [embed] });
}

//#endregion
export { chatInput, command };
//# sourceMappingURL=pyam-sec-key-card.js.map