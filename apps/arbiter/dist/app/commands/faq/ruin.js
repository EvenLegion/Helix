...
//#region src/app/commands/faq/ruin.ts
const command = {
	name: "ruin",
...
async function chatInput({ interaction }) {
	...
	const embed = new EmbedBuilder().setColor("#701515").setTitle("Welcome to Ruin Station!").setDescription(`Hello <@${user.id}>, here is the latest information for Ruin Station and where to find the Comp boards inside of Ruin Station Contested Zone.`).addFields({
		...
		inline: false
	}).setImage("https://i.postimg.cc/1z3fpCwX/Ruin-Map.webp").setFooter({ text: "Ruin Station Contested Zone - Map and Information" });
	await interaction.reply({ embeds: [embed] });
}

//#endregion
export { chatInput, command };
//# sourceMappingURL=ruin.js.map