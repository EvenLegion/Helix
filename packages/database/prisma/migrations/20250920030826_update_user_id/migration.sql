...
ALTER COLUMN "awarded_by" SET DATA TYPE VARCHAR(19),
ADD CONSTRAINT "merit_pkey" PRIMARY KEY ("userID");

-- AlterTable
ALTER TABLE "arbiter"."name_change_request" ALTER COLUMN "userId" SET DATA TYPE VARCHAR(19),
ALTER COLUMN "approvedBy" SET DATA TYPE VARCHAR(19);

-- AlterTable
ALTER TABLE "nexus"."invitation" ALTER COLUMN "inviterId" SET DATA TYPE VARCHAR(19);

-- AlterTable
ALTER TABLE "nexus"."member" ALTER COLUMN "userId" SET DATA TYPE VARCHAR(19);
