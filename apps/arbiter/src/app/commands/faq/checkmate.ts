...
export async function chatInput({ interaction }: ChatInputCommandContext) {
    ...
    const embed = new EmbedBuilder() // New embed for checkmate command //Hopefully this works
        .setColor('#701515')
        .setTitle('Welcome to Checkmate!')
        .setDescription(`Hello <@${user.id}>, here is the latest information for Checkmate and where to find the Comp boards inside of Checkmate Contested Zone.`)
        .addFields(
            {
                name: "Comp Board One",
        ...
        .setImage('https://i.postimg.cc/pVwrDpd9/contested-zones-maps-orbituary-ruin-station-checkmate-v0-tc3na435mbde1.webp')
        .setFooter({text: 'Checkmate Contested Zone - Map and Information'})
