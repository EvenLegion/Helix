/*
  ...
  - You are about to drop the column `is` on the `invitation` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE "nexus"."invitation" DROP CONSTRAINT "invitation_pkey",
DROP COLUMN "is",
