...
export async function chatInput({ interaction }: ChatInputCommandContext) {
    ...
    const embed = new EmbedBuilder() // New embed for Fleetyard
        .setColor('#701515')
        .setTitle('Welcome to Fleetyard!')
        .setDescription(`Hello <@${user.id}>, here is the latest information for Fleetyard and how to join the EvenLegion Fleetyard.`)
        .addFields(
            {
        ...
        .setImage('https://i.postimg.cc/vBYxCk8B/Discord-Banner-5.gif')
        .setFooter({text: 'Join the EvenLegion Fleetyard Today!'});
